...
namespace dmzx\fileupload\event;
...
class listener implements EventSubscriberInterface
{
	...
	*/
	...
	{
		if (strrpos($event['row']['session_page'], 'app.' . $this->php_ext . '/fileupload') === 0)
		{
			$event['location'] = $this->user->lang('FILEUPLOAD_UPLOAD_SECTION');
			$event['location_url'] = $this->helper->route('dmzx_fileupload_controller_upload', array('name' => 'index'));
		}
	}
